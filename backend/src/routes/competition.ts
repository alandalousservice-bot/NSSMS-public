...
const resultList = page.extend({ stage_id: id.optional(), occurrence_id: id.optional(), event_id: id.optional(), category_id: id.optional(), competition_entry_id: id.optional(), regulation_version_id: id.optional(), status: z.enum(['DRAFT', 'SUBMITTED', 'VALIDATED', 'REJECTED', 'VOID', 'ARCHIVED', 'LEGACY_UNRESOLVED']).optional(), evidence_candidate: z.enum(['true']).transform(() => true).optional() });
